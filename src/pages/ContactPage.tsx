...
const pageData = {
  hu: {
    ...
    pricesNote2: 'Minimum tartózkodás: 2 éjszaka.',
    ...
    checklist: [
      ...
      { icon: CreditCard, text: 'Fizetési mód: banki átutalás' },
...
Köszönettel:`,
  ...
  en: {
    ...
    pricesNote2: 'Minimum stay: 2 nights.',
    ...
    checklist: [
      ...
      { icon: CreditCard, text: 'Payment method: bank transfer' },
