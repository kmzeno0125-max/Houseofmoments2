...
const passionImg2 = '/assets/felszereltseg/WhatsApp_Image_2026-05-30_at_07.17.38%20copy%202.jpeg';

const botanicImg2 = '/assets/felszereltseg/WhatsApp_Image_2026-05-30_at_07.19.53.jpeg';
...
const botanicImages = [
  { src: botanicImg, altHu: 'Botanic szoba zöld növényfallal és trópusi dekorral', altEn: 'Botanic room with green plant wall and tropical decor' },
  { src: botanicImg2, altHu: 'Botanic szoba zöld fényekkel és növényes hangulattal', altEn: 'Botanic room with green lighting and botanical atmosphere' },
];
...
function RoomSlider({ images }: { images: typeof passionImages }) {
    ...
    >
      <AnimatePresence initial={false} custom={direction} mode="popLayout">
        <motion.img
          ...
          alt={images[current][altKey as keyof typeof images[0]]}
          custom={direction}
          variants={variants}
          initial="enter"
          animate="center"
            ...
            {data.rooms.map((room, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {isPassion ? (
                      <RoomSlider images={passionImages} />
                    ) : i === 1 ? (
                      <RoomSlider images={botanicImages} />
                    ) : (
                      <img
                        src={passionImg}
                        alt={room.alt}
