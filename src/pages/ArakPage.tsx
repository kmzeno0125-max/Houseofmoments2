...
const t = {
  hu: {
    ...
    ratesNote2: 'Minimum tartózkodás: 2 éjszaka.',
    ratesNote3: 'Kiemelt időszakokban és speciális dátumokon az árak eltérhetnek.',
  ...
  en: {
    ...
    ratesNote2: 'Minimum stay: 2 nights.',
    ratesNote3: 'Rates may vary during peak periods and on special dates.',
